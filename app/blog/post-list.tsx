...
export default function BlogIndex({posts}:{posts:Post[]}){
 ...
 return <>
  <section className="b-feature-grid"><div className="b-welcome b-card"><span className="b-overline">DUMBO / JOURNAL</span><h1>记录，是为了<br/><span>更好地出发。</span></h1><p>关于代码、学习，和那些值得记住的小事。</p><a href="#articles">从最新文章开始 <ArrowRight size={18}/></a><div className="b-topic-strips"><span>CODE</span><span>LEARN</span><span>LIFE</span></div></div>
